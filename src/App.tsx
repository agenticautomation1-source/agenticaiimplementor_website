    ...
    <div className="min-h-screen flex flex-col bg-background-dark text-slate-100">
      ...
      <main className="flex-1">
        <Routes>
          ...
          {/* ================= COURSES ================= */}
          <Route path="/courses" element={<Courses />} /> {/* ✅ ADDED */}
  ...
  <div className="flex flex-col gap-3">
    ...
    <p className="text-slate-500 text-sm max-w-sm">
      ...
      <div className="flex flex-col gap-4">
        ...
        <Link to="/about" className="text-slate-500 hover:text-primary text-sm">
          About
        </Link>
        <Link to="/contact" className="text-slate-500 hover:text-primary text-sm">
          Contact
        </Link>
      </div>
    ...
    <div className="pt-8 border-t border-white/5 flex justify-between text-slate-600 text-xs">
      ...
      <p>© {new Date().getFullYear()} Agentic AI Integrators</p>
    </div>
