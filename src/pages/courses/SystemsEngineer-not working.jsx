...
export default function SystemsEngineer() {
   ...
   * - App.tsx hydrates auth
   * - This page only reads session + reacts
   */
  useEffect(() => {
    let mounted = true;
    ...
    const { data: listener } = supabase.auth.onAuthStateChange(
      async (_event, newSession) => {
        if (newSession && mounted) {
          ...
          await storeLead(newSession.user);
        }
      }
    );
    ...
    await supabase.auth.signInWithOAuth({
      ...
      options: {
        redirectTo:
          ...
          "/courses/agentic-ai-systems-engineer",
      },
    });
  };
            ...
            <>
              ...
              >
                <svg width="18" height="18" viewBox="0 0 48 48">
                  <path fill="#EA4335" d="M24 9.5c3.5 0 6.7 1.2 9.2 3.2l6.9-6.9C35.8 1.8 30.3 0 24 0 14.6 0 6.6 5.4 2.6 13.2l8.4 6.5C13.1 13.1 18.1 9.5 24 9.5z"/>
                  <path fill="#4285F4" d="M46.5 24c0-1.6-.1-3.2-.4-4.7H24v9h12.7c-.6 3-2.2 5.5-4.7 7.2l7.1 5.5C43.9 36.8 46.5 31 46.5 24z"/>
                  <path fill="#FBBC05" d="M11 28.7c-.5-1.4-.8-3-.8-4.7s.3-3.3.8-4.7l-8.4-6.5C.9 16.1 0 20 0 24s.9 7.9 2.6 11.3l8.4-6.6z"/>
                  <path fill="#34A853" d="M24 48c6.3 0 11.8-2.1 15.8-5.6l-7.1-5.5c-2 1.3-4.5 2.1-8.7 2.1-5.9 0-10.9-3.6-13-8.7l-8.4 6.5C6.6 42.6 14.6 48 24 48z"/>
                </svg>
          ...
          {session && (
            <div className="mt-6 space-y-4">
              ...
              <button
                ...
                onClick={() =>
                  navigate(
                    "/lms/courses/masterstroke-agentic-ai-systems-engineer"
                  )
                }
